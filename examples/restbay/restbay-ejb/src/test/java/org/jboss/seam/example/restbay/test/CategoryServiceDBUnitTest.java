...
public class CategoryServiceDBUnitTest extends DBJUnitSeamTest
{
   ...
   {
<<<<<<< HEAD:examples/restbay/restbay-tests/src/test/java/org/jboss/seam/example/restbay/test/CategoryServiceDBUnitTest.java
...
=======
      ...
      web.addAsLibraries(Maven.resolver().loadPomFromFile("pom.xml")
    		  	...
    		  	.withoutTransitivity()
                .asFile());
>>>>>>> origin/Seam_2_3:examples/restbay/restbay-ejb/src/test/java/org/jboss/seam/example/restbay/test/CategoryServiceDBUnitTest.java
